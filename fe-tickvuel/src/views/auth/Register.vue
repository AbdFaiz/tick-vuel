    ...
    <form class="space-y-6" @submit.prevent="handleSubmit">
        ...
        <div>
            ...
            <div class="mt-1 relative">
                ...
                <p class="mt-1 text-xs text-red-500" v-if="error?.name">{{ error?.name?.join(', ') }}</p>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="mt-1 relative">
                ...
                <p class="mt-1 text-xs text-red-500" v-if="error?.email">{{ error?.email?.join(', ') }}</p>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="mt-1 relative">
                ...
                <p class="mt-1 text-xs text-red-500" v-if="error?.password">{{ error?.password?.join(', ') }}</p>
            </div>
        </div>
